...
new autoComplete({
    data: {                              // Data src [Array, Function, Async] | (REQUIRED)
        ...
        key: ["title", "authors", "genre", "language", "spot", "isbn", "abstract", "code", "loan"],
        cache: false
    },
    ...
    resultItem: {                          // Rendered result item            | (Optional)
        content: (data, source) => {
            ...
            source.innerHTML = book.title + " - " + book.authors + " - " + book.genre + " - " + book.year + " - " + book.isbn + " - " + book.code + " - " + book.loan
        },
        element: "li"
    },
